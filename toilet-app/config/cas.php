...
return [
    ...
    */
    'cas_hostname' => env('CAS_HOSTNAME', 'shib.idm.umd.edu/shibboleth-idp/profile/'),
    ...
    */
    'cas_real_hosts' => env('CAS_REAL_HOSTS', 'shib.idm.umd.edu/shibboleth-idp/profile/'),
    ...
    */
    'cas_logout_redirect' => env('CAS_LOGOUT_REDIRECT', '/home'),
